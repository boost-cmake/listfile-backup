...
function(ryppl_doxygen name)
  if(NOT DOXYGEN_EXECUTABLE OR NOT XSLTPROC_EXECUTABLE)
    return()
  endif()
  ...
  file(RELATIVE_PATH rel_output ${CMAKE_BINARY_DIR} ${DOXY_OUTPUT})
  ...
  if(DOXY_XML)
    ...
    xsltproc(
      ...
      COMMENT    "merge several doxygen XMLs into one: ${rel_output} ..."
    )
  endif()
endfunction()
